...
describe LinkThumbnailer do
  ...
  describe ".configure" do
    ...
    specify { LinkThumbnailer.configuration.fastimage_attributes.should   eq([]) }
  ...
  context "default values" do
    ...
    specify { LinkThumbnailer.configuration.fastimage_attributes.should   eq(%w(source_url size type)) }
  ...
  describe ".generate" do
    ...
    context "with valid arguments" do
      ...
      context "and options" do
        ...
        it "should set fastimage_attributes option" do
          expect { LinkThumbnailer.generate('foo', fastimage_attributes: %w(one two)).to change(LinkThumbnailer.configuration.fastimage_attributes).to(%w(one two)) }
        end
